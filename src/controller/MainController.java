...
public class MainController {
	...
	/**
	 * Send a vector of Tile to see which Tile are in range of the unit's
	 * attack.
	 * 
	 * @param tiles
	 ...
	 * @return An unit if there is an unit in this Tile, null if there is no
	 *         unit
	 */
	...
	/**
	 * Send a two dimensions String array which contains unit and positions of
	 * player A.
	 * 
	 ...
	 */
	public synchronized void recPlayer() {
