...
public abstract class Unit {
	...
	public Unit(IAttack attack, int hp, int dmg, int hit, int move, int def, int crit, int mat, Weapon wep, String name) {
		this.attack = attack;
		this.hp = hp;
		this.dmg = dmg;
		this.hit = hit;
	...
	{
		this.hp -= dmg;
		if(this.hp <= 0 ) throw new DeadUnitException(this.name, dmg);
	}
